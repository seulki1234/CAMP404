...
ALTER TABLE ELEARNING.MY_LECTURE ADD CONSTRAINT FK_USERS2 FOREIGN KEY (USERS_NO) REFERENCES ELEARNING."USERS"(USERS_NO) ON DELETE CASCADE;
...
ALTER TABLE ELEARNING.FAV_LEC ADD CONSTRAINT FK_USERS FOREIGN KEY (USERS_NO) REFERENCES ELEARNING."USERS"(USERS_NO) ON DELETE CASCADE;
...
ALTER TABLE ELEARNING.PAYMENT ADD CONSTRAINT FK_USERS3 FOREIGN KEY (USERS_NO) REFERENCES ELEARNING."USERS"(USERS_NO) ON DELETE CASCADE;
...
ALTER TABLE ELEARNING.LECTURE_NOTE ADD CONSTRAINT FK_USERS10 FOREIGN KEY (USERS_NO) REFERENCES ELEARNING."USERS"(USERS_NO) ON DELETE CASCADE;
