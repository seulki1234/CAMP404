...
$('.writeButton').click(function(){
  ...
  $('.subArea').hide();/*저장된 강의노트 목록 show */ 
    ...
    function setToDo(a){
      ...
      $('.counterOuter').css("color","black") //기본 css 설정
      ...
      addWrapper.innerHTML = `
        <div class = "addArea">
            ...
            <span class="change"><i class="fa-solid fa-pencil"></i></span>
        ...
        <div class="slideWrapper">
            ...
            <div class = "slideArea">
                ...
                <div class="counterWrapper">
                    <span class="counter">${typeData.value.length}</span> / 30
                </div>
            </div>
        </div>

        <button class="writeButton">글 작성</button>
...
// const change = addWrapper.querySelector('.change');//수정하기 누르면 수정
...
// const writeButton = addWrapper.querySelector('.writeButton');//글작성 
// writeButton.classList.add('remove')
...
//엔터입력
// typeData.addEventListener('keyup', (e)=>{
//   if(e.which === 13){
//     setToDo();
//   }
// });
